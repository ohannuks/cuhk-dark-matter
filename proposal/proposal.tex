...
neutrino and gamma-ray signals \citep{2015_Arina__Silk}  % Note: this could be modified
...
context. For a review of indirect dark matter detection, see for example 
...
\citep{schnittman2015}, studied distributions of dark matter 
...
and adiabatic growth \citep{GS_2009, Laleh_GR_DM_distributions}, as well 
as two-component models including gravitational scattering of stars 
with dark matter,
whereas the numerical work by Jeremy Schnittman 
...
in a similar fashion, forming steep cusps. Additionally, such cusps have not been 
...
The current research on dark matter largely focuses on what dark matter is made of and how it affects the universe, 
...
indirectly detecting dark matter \citep{gondolo2000dmsearch,bertone2001dmsearch}. % Note to self: dump the observational citations into one sentence
...
\citep{ullio2001spike_criticism}, as well as two-component Fokker-Planck models independent of initial conditions that would produce a 
smaller mini spike have been considered\citep{gnedin_primack_2004}.  % Gnedin article should be read -very carefully- and see also the criticism on it
...
The study did not simulate the adiabatic 
...
stellar matter \citep{ullio2001spike_criticism}. 
On another other front it is 
argued that such highly dense stellar matter could not have existed 
for so long. %\citep{I_dont_remember_this_one}. Note: also, the above sentence is kind of vague
...
fate of these highly dense spikes is still undecided, and establishing a firm basis for the 
...
stellar orbits, similarly as in \citep{Sadeghian_Ferrer_Will_2013}. 
% Note: The above sentence needs more justification; just saying we do it because they did it is kind of lame

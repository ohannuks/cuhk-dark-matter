...
\begin{enumerate}
 ...
 \item Evolve the phase space to a stable state under constant Kerr metric % Note: for this one, we might even consider looking into the stellar scattering paper, since we might be able to construct a DM spike even without BH growth
 \item Evolve Kerr metric by increasing Kerr properties (mass and/or spin)
 \item 
\end{enumerate}

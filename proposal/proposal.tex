...
% Questions:
%  How realistic is a merger event? Would we be able to detect anything?
%   if during merging -> annihilation not settled, but eventually 
%   should settle
...
distribution. % Motivate the following somehow
